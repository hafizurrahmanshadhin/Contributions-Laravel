                ...
                <div class="card-style mb-4">
                    <form method="POST" action="{{ route('stripe.update') }}">
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="Enter stripe key" id="STRIPE_PUBLIC_KEY"
                        ...
                        <div class="input-style-1">
                            <label for="STRIPE_SECRATE_KEY">STRIPE_SECRET:</label>
                            <input type="text" placeholder="Enter stripe secret" id="STRIPE_SECRATE_KEY"
                                class="form-control @error('STRIPE_SECRATE_KEY') is-invalid @enderror"
